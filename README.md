...
> 2024 Q4 已完成依赖升级：Next.js 15.0.3、Stripe Node 18.x、Supabase JS 2.48、Dynamic SDK 3.x、TypeScript 5.6、ESLint 9，并通过 `overrides` 强制提升 WalletConnect、glob、rimraf 等传递依赖版本，以消除常见的 npm WARN。
